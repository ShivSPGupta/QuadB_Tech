...
function CTASection() {
  return (
    <section className="flex flex-col justify-center p-16 w-full border border-solid border-[#262626] max-w-[1278px] max-md:px-5 max-md:max-w-full">
      <div className="flex flex-wrap gap-8 items-center w-full text-neutral-400 max-md:max-w-full">
        <img
          src="https://shivshankar1201.sirv.com/digital-agency/Contact/CTASection/SquareUp%20Logo.svg"
          alt="SquareUp Logo"
      ...
      <div className="flex flex-wrap gap-5 justify-center items-center px-8 py-5 mt-10 w-full rounded-xl border border-solid backdrop-blur-[6px] bg-neutral-800 bg-opacity-20 border-[#262626] max-md:px-5 max-md:max-w-full">
